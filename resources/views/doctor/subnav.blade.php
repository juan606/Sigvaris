<ul class="nav nav-pills nav-fill">
    ...
    <li role="presentation" class="nav-item"><a href="{{ route('doctores.premios.index', ['doctor' => $doctor]) }}" id="nav-premios" class="nav-link submenu">Reconocimientos/Cargos:</a></li>
