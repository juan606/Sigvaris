...
<div class="container">
    ...
    <div class="card">
        <form role="form" method="POST" action="{{ route('roles.update',['role'=>$role]) }}">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label" for="nombre"><i class="fa fa-asterisk" aria-hidden="true"></i>
                            Nombre
                            del Rol:</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" required autofocus value="{{ $role->nombre }}">
                    </div>
                    <div class="form-group col-6">
