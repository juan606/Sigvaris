            ...
            <form role="form" name="domicilio" id="form-cliente" method="POST" action="{{ route('pacientes.tallas.update', ['paciente'=>$paciente, 'talla'=>$talla]) }}" name="form">
                ...
                <div class="form-group col-6">
                    ...
                    <div class="form-group col-12">
                        ...
                        <select class="form-control compresion" name="pierna" id="pierna" required>
                ...
                <div class="form-group col-3 estilos-brazo">
                    <h5>Estilos Brazo</h5>
                    <div class="form-check">
                        <input name="guante" class="form-check-input cb-brazo-estilo" type="checkbox" value="{{$talla->guante}}" id="guante">
            ...
            <div class="row">
                ...
                <div class="form-group col-6 estilos-brazo">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input value="{{$talla->talla_dcha}}" name="talla_dcha" id="talla_dcha" type="text" class="form-control medidas-brazo">
                        </div>
                    </div>
